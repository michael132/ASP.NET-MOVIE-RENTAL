namespace Vidly.Migrations
{
    ...
    public partial class CorrectMembershipTypeIdInCustomerModel : DbMigration
    {
        public override void Up()
        {
            ...
            DropColumn("dbo.Customers", "MembershipTpyeId");
        }
        
        public override void Down()
        {
            AddColumn("dbo.Customers", "MembershipTpyeId", c => c.Byte(nullable: false));
